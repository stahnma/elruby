...
# stahnma: added to allow upgrades from previous rubies
...
# stahnma: let's just leave it as ruby
...
%changelog
* Sun Feb 24 2013 <stahnma@fedoraproject.org> - 2.0.0-100.1
- Initial build for elruby
